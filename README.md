...
2.How to create environment with my file .yaml :conda env create  -f "name file ".yml
...
* Use run my code :dowload my dataset and code .Save it into a file. Copy the address of that file .Then open your anaconda prompt , create env with my file .yml .Activate this env .Finally comand :
